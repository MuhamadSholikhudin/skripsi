    ...
    <div class>
        ...
        <div class="row">
            <div class="table-responsive">
                ...
                <table class="display text-dark" style="width:100%" border="1" role="grid" aria-describedby="DataTables_Table_0_info">
                            ...
                            <tr>
                                ...
                                <?php if ($pilihan[0] == 'menu') { ?>
                                    <?php if (($debet_bulan_kemarin  ) > ($kredit_bulan_kemarin   )) { ?>
                                        <?php if (($debet_bulan_kemarin   ) > ($kredit_bulan_kemarin  )) { ?>
                                            <td><?= rupiah1(($debet_bulan_kemarin   )  - ($kredit_bulan_kemarin   )) ?></td>
                                            <td></td>
                                        <?php } elseif (($debet_bulan_kemarin   ) < ($kredit_bulan_kemarin   )) { ?>
                                            <td></td>
                                            <td><?= rupiah1(($kredit_bulan_kemarin   ) - ($debet_bulan_kemarin   )) ?></td>
                                        <?php } ?>
                                    <?php } elseif (($debet_bulan_kemarin   ) < ($kredit_bulan_kemarin   )) { ?>
                                        <?php if (($debet_bulan_kemarin   ) > ($kredit_bulan_kemarin   )) { ?>
                                            <td><?= rupiah1(($debet_bulan_kemarin   ) - ($kredit_bulan_kemarin   )) ?></td>
                                ...
                                <?php
                                if ($pilihan[0] == 'menu') {
                                    $nsdebet = $debet_bulan_kemarin  ;
                                    $nsdkredit = $kredit_bulan_kemarin  ;
                                }
                            ...
                            <td>
                                ...
                                if ($pilihan[0] == 'menu') { ?>
                                    ...
                                    foreach ($akun as $ak) : ?>
                                        ...
                                        $e = $g5['debet'] + $g5['kredit'];
                                        ?>
                                        <?php if (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) > ($g1['kredit']  )) {
                                            $total_debet += (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) - ($g1['kredit']  ))  ?>

                                        <?php } elseif (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) < ($g1['kredit']  )) { ?>
                            ...
                            <td>
                                ...
                                if ($pilihan[0] == 'menu') { ?>
                                    ...
                                    foreach ($akun as $ak) : ?>
                                        ...
                                        <?php } elseif (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) < ($g1['kredit']  )) {
                                            $total_kredit += (($g1['kredit']  ) - ($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet'])) ?>
                                        <?php } else {
                                        } ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td> </td>
                            <td> </td>
                            <td><?= rupiah1($latotal_debet - $latotal_kredit) ?> </td>
                            <td> </td>
                            <td> </td>
                            <td><?= rupiah1($nrtotal_kredit - $nrtotal_debet) ?> </td>
                ...
                <p>
                    Selisih-nya : <?= rupiah1($latotal_debet - $latotal_kredit) ?>
                </p>
                <br>


                <p>
                    Selisih-nya : <?= rupiah1($nrtotal_kredit - $nrtotal_debet) ?>
                </p>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($akun as $ak) : ?>
                            ...
                            <tr>
                                ...
                                <?php if ($pilihan[0] == 'menu') { ?>
                                    <?php if (($debet_bulan_kemarin   ) > ($kredit_bulan_kemarin   )) { ?>
                                        <?php if (($debet_bulan_kemarin   ) > ($g1['kredit']  )) { ?>
                                            <td><?= rupiah1(($debet_bulan_kemarin   )  - ($kredit_bulan_kemarin   )) ?></td>
                                            <td></td>
                                        <?php } elseif (($debet_bulan_kemarin   ) < ($kredit_bulan_kemarin   )) { ?>
                                            <td></td>
                                ...
                                if ($pilihan[0] == 'menu') {
                                    ...
                                    $nsdkredit = $kredit_bulan_kemarin  +  $g1['kredit']  ;
                                }
                                if (($nsdebet + $jpsr->debet) > ($nsdkredit + $jpsr->kredit)) { ?>
                                    <td><?= rupiah1(($nsdebet + $jpsr->debet) - ($nsdkredit + $jpsr->kredit)) ?></td>
                                    <td></td>
                                ...
                                ?>
                                    <?php if (($sg1['debet'] + $sg2['debet'] + $sg3['debet'] + $sg4['debet'] + $sg5['debet'] + $sg6['debet']) > ($sg1['kredit'] + $sg2['kredit'] + $sg3['kredit'] + $sg4['kredit'] + $sg5['kredit'] + $sg6['kredit'])) { ?>
                                        <tr>
                                            <td><?= $ak->no_akun ?></td>
                                            <td><?= $ak->nama_akun ?></td>
                                            <td><?= rupiah($saldo_bulan_kemarin) ?> </td>
                                            <td></td>
                                        </tr>
                            ...
                            <?php } else { ?>
                                ...
                                <?php if ($g5['debet'] != $g5['kredit']) { ?>
                                    <tr>
                                        ...
                                        <?php if (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) > ($g1['kredit']  )) { ?>
                                            <td><?= rupiah(($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) - ($g1['kredit']  )) ?></td>
                                            <td></td>

                                        <?php } elseif (($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet']) < ($g1['kredit']  )) { ?>
                                            <td></td>
                                            <td><?= rupiah(($g1['kredit']  ) - ($g1['debet'] + $g2['debet'] + $g3['debet'] + $g4['debet'] + $g5['debet'])) ?></td>
                                        <?php } ?>
                                    </tr>
                                <?php } else { ?>
