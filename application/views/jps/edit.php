                            ...
                            <?php if ($jps->no_akun == 211) { ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="id_jps_akun_utang1" name="id_jps_akun_utang1" value="<?= $jps->no_akun ?>" placeholder="jpsmlah penjpsalan" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="no_akun_pembelian" name="no_akun_returpembelian" value="<?= $jpsre['no_akun'] ?>" placeholder="jpsmlah" required>
                            ...
                            <?php } elseif ($jps->no_akun == 412) { ?>
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="no_akun_retur_penjpsalan" name="no_akun_retur_penjpsalan" value="<?= $jps->no_akun ?>" placeholder="jpsmlah" required>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" name="id_jps_akun_piutang_dagang" value="<?= $jps_1['no_akun'] ?>" required>
