...
$nama_2 = $this->db->query($nama_kredit)->row_array();
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="id_jps1" name="id_jps1" value="<?= $jps->id_jps ?>" placeholder="jpsmlah" required>
                                        <input class="form-control" type="number" id="no_akun1" name="no_akun1" value="<?= $jps->no_akun ?>" placeholder="jpsmlah" required>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="number" id="id_jps2" name="id_jps2" value="<?= $akun_2['id_jps'] ?>" required>
                                        <input class="form-control" type="number" id="no_akun2" name="no_akun2" value="<?= $akun_2['no_akun'] ?>" required>
