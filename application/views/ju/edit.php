    ...
    <div class>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Edit Data Jurnal Umum</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br>
                        <?php
                        if ($pilihan[0] == 'menu') { ?>
                            <form class="bg-white pd-20" action="<?= base_url('pilihan/ju/aksi_edit') ?>" method="POST" enctype="multipart/form-data">
                            <?php } else { ?>
                                ...
                                <?php } elseif ($ju->no_akun == 412) { ?>
                                    ...
                                    <div class='form-group row'>
                                        ...
                                        <div class='col-sm-12 col-md-10'>
                                            ...
                                            <?php
                                            $jupiutang = "SELECT * FROM jurnal_umum WHERE no_transaksi = '$ju->no_transaksi' AND no_akun != 412";
