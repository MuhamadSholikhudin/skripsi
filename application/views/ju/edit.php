                            ...
                            <?php if ($ju->id_akun == 8) { ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="id_ju_akun_utang1" name="id_ju_akun_utang1" value="<?= $ju->id_akun ?>" placeholder="Jumlah penjualan" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <?php
                                        $juretur = "SELECT * FROM ju WHERE no_transaksi = '$ju->no_transaksi' AND id_akun != 8";
                                        ...
                                        <input class="form-control" type="number" id="id_akun_pembelian" name="id_akun_returpembelian" value="<?= $jure['id_akun'] ?>" placeholder="Jumlah" required>
                                        <input class="form-control" type="number" id="ju_retur_pem11" name="kredit1" value="<?= $jure['kredit'] ?>" placeholder="Jumlah" required>
                                    </div>
                                </div>

                            <?php } elseif ($ju->id_akun == 13) { ?>
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" id="id_akun_retur_penjualan" name="id_akun_retur_penjualan" value="<?= $ju->id_akun ?>" placeholder="Jumlah" required>
                                ...
                                <div class='form-group row'>
                                    ...
                                    <div class='col-sm-12 col-md-10'>
                                        ...
                                        <?php
                                        $jupiutang = "SELECT * FROM ju WHERE no_transaksi = '$ju->no_transaksi' AND id_akun != 13";
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        ...
                                        <input class="form-control" type="number" name="id_ju_akun_piutang_dagang" value="<?= $ju_1['id_akun'] ?>" required>
