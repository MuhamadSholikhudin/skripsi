        ...
        <script>
          ...
          $("#kategori_ju").change(function() {
            ...
            // $("#ju_retur_penjualan22").keydown(function() {
            //   var jumlah = $(this).val();
            //   $("#ju_piutang").val(jumlah);
            // });
            // $("#ju_retur_penjualan22").keyup(function() {
            //   var jumlah = $(this).val();
            //   $("#ju_piutang22").val(jumlah);
            // });
