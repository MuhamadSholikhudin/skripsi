                ...
                <tbody>
                    <?php foreach ($akun as $ak) : ?>
                        <tr>
                            ...
                            <!-- Jurnal Penyesuaian -->
                            <?php
                            $jps1 = $this->db->query("SELECT SUM(debet) as debet, SUM(kredit) as kredit FROM jps WHERE no_akun = $ak->no_akun ");
                            $jpsr = $jps1->row();
                            if ($jps1->num_rows() > 0) {
                                if ($jpsr->debet > 0) { ?>
                                    <td>
                    ...
                    <tr>
                        ...
                        <?php
                        $jp1 = "SELECT SUM(debet) as debet_jps, SUM(kredit) as kredit_jps FROM jps ";
