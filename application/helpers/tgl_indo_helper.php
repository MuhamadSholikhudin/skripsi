...
if (!function_exists('tanggal_pilih')) {
	function tanggal_pilih($tanggal)
	{
		$ubah = gmdate($tanggal, time() + 60 * 60 * 8);
		$pecah = explode("-", $ubah);
		$tgl = $pecah[2];
...
//Long date medium indo Format
if (!function_exists('tgl_bln_th')) {
	function tgl_bln_th($tanggal)
	{
		$ubah = gmdate($tanggal, time() + 60 * 60 * 8);
		$pecah = explode("-", $ubah);
		$tgl = $pecah[2];
...
if (!function_exists('tgl_bln_thn')) {
	function tgl_bln_thn($tanggal)
	{
		$ubah = gmdate($tanggal, time() + 60 * 60 * 8);
		$pecah = explode("-", $ubah);
		$tgl = $pecah[2];
