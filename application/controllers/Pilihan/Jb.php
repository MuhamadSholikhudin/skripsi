...
class Jb extends CI_Controller
{
    ...
    {
        $data['jb'] = $this->db->query("SELECT * FROM jurnal_pembelian WHERE MONTH(tanggal) = $bulan_pilih AND YEAR(tanggal) = $tahun_ini GROUP BY no_transaksi ORDER BY tanggal ASC")->result();
